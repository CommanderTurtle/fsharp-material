...
> **Further Reading:** 
> `documentation/architecture/README.md` : [/architecture/README.md](./documentation/architecture/README.md)
...
- For more, see architecture docs: [/architecture/README.md](documentation/architecture/README.md)
